    ...
    <>
      ...
      <section className="bg-navy py-16 md:py-24 px-4">
        <div className="max-w-[800px] mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-white text-lg mb-4">
          ...
          <p className="text-white text-sm">{event.location_address}</p>
          <div className="mt-6">
            {event.is_free ? (
