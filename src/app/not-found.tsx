...
const cities = [
  ...
  { name: "Murfreesboro", day: "Wed 8:30am", href: "/tn/murfreesboro", color: "#4A6A8B" },
  { name: "Nolensville", day: "Thu 9:00am", href: "/tn/nolensville", color: "#F5BE61" },
  { name: "Smyrna", day: "Fri 9:00am", href: "/tn/smyrna", color: "#FE6651" },
];
  ...
  return (
    <div className="min-h-screen bg-navy flex items-center justify-center px-4 py-16">
      <div className="text-center max-w-xl">
        ...
        <p className="text-white text-lg leading-relaxed max-w-[500px] mx-auto mb-8">
